...
class UpdateProfilePresenter<View : UpdateProfileView> @Inject constructor(var updateProfileInteractor: UpdateProfileInteractor) : BasePresenter<View>(), IUpdateProfileListener<View>, UpdateProfileInteractor.OnCallHitListener {
